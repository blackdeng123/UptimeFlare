...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://blog.acofork.com/posts/uptimeflare/', label: '项目copy' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '吉首大学教务系统',
      method: 'HEAD',
      target: 'https://jwxt.jsu.edu.cn/jsxsd/',
      statusPageLink: 'https://jwxt.jsu.edu.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '吉首大学门户系统',
      method: 'HEAD',
      target: 'https://webvpn.jsu.edu.cn',
      statusPageLink: 'https://webvpn.jsu.edu.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    }
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@noreply.shisanjike.icu>",
        "to": ["czdengtianxiang666@163.com"],
